...
spawn coord   python3 "$A/fanout_actor.py" worker-up worker-rev
...
check "worker-up: HELLO"    "fanout reached upper worker"
check "worker-rev: olleh"   "fanout reached reverse worker"
